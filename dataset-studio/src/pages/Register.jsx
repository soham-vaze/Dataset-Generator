...
export default function Register() {
  ...
  const features = [
    { icon: "M13 10V3L4 14h7v7l9-11h-7z", label: "Generate datasets in minutes, not hours" },
    { icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z", label: "100% local — your data never leaves your machine" },
    { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", label: "6 specialized dataset generators" },
  ];
  ...
  return (
    <div className="relative min-h-screen flex overflow-hidden">
      ...
      <div className="fixed inset-0 z-[1] pointer-events-none overflow-hidden">
        <div className="absolute -top-[25%] -right-[15%] w-[700px] h-[700px] rounded-full bg-blue-500/[0.04] blur-[120px] animate-float" />
        <div className="absolute -bottom-[20%] -left-[10%] w-[600px] h-[600px] rounded-full bg-primary/[0.03] blur-[100px] animate-float" style={{ animationDelay: "-3s" }} />
        <div className="absolute top-[50%] right-[50%] w-[400px] h-[400px] rounded-full bg-emerald-500/[0.02] blur-[80px] animate-float" style={{ animationDelay: "-5s" }} />
      </div>
      ...
      <div className="hidden lg:flex lg:w-[52%] relative z-10 flex-col justify-between p-14 xl:p-16">
        ...
        <div className="max-w-xl">
          ...
          >
            <motion.span variants={fadeUp} custom={1} className="block text-zinc-100">
              Start Building
            </motion.span>
            <motion.span variants={fadeUp} custom={2} className="block text-gradient">
              AI Datasets
            </motion.span>
            <motion.span variants={fadeUp} custom={3} className="block text-gradient-blue">
              Today
            </motion.span>
          </motion.h1>
          ...
          >
            {features.map((feature, i) => (
              ...
              >
                <div className="w-9 h-9 rounded-xl bg-white/[0.03] border border-white/[0.06] flex items-center justify-center shrink-0 group-hover:bg-white/[0.06] group-hover:border-white/[0.1] transition-all duration-300">
                  <svg className="w-4 h-4 text-primary-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                    <path strokeLinecap="round" strokeLinejoin="round" d={feature.icon} />
                  </svg>
                </div>
                <span className="text-sm text-zinc-400 group-hover:text-zinc-300 transition-colors">{feature.label}</span>
              </motion.div>
            ))}
          </motion.div>
        </div>
      ...
      <div className="flex-1 flex items-center justify-center relative z-10 p-6 lg:p-12">
        ...
        >
          <div className="glass-card p-8 md:p-10 relative overflow-hidden">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-bold text-zinc-100 tracking-[-0.02em]">Create account</h2>
          ...
          {/* Bottom glow */}
          <div className="absolute -bottom-8 left-1/2 -translate-x-1/2 w-3/4 h-16 bg-blue-500/[0.06] blur-[40px] rounded-full pointer-events-none" />
        </motion.div>
      </div>
    </div>
  );
