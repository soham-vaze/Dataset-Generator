  ...
  if (loading)
    return (
      <div className="flex items-center justify-center h-screen bg-dark">
        ...
        >
          <div className="w-10 h-10 rounded-xl bg-primary/[0.12] border border-primary/[0.2] flex items-center justify-center">
  ...
  return (
    <div className="flex flex-col h-screen bg-dark">
      ...
      <div className="relative z-10 flex flex-col h-full p-6">
        ...
        >
          <div className="w-8 h-8 rounded-xl bg-primary/[0.1] border border-primary/[0.18] flex items-center justify-center">
