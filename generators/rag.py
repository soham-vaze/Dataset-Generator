...
def build_prompt_by_difficulty(difficulty: str) -> str:
    print(f"Building the prompt according to {difficulty} level.")
    if difficulty == "easy":
        return (
...
def grounding_overlap_check(answer: str,
    ...
    print(f"overrlap ratio obtained: {overlap_ratio}")
...
def length_check(answer: str,
    ...
    print(f"Entrering vallidation layer 2ssssss")
...
def llm_consistency_check(context: str,
                          ...
                          answer: str,
                          model: str) -> bool:
    print(f"Entering valiidation layer 3.")
    judge_prompt = (
...
# =====================================================
# 6️⃣ VALIDATION LAYER 4: Ollama Embedding Semantic Check
# =====================================================
...
def semantic_similarity_check(answer: str,
    ...
    print(f"Entering validation layer 4.")
