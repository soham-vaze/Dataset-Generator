"""
Dataset Generator API — Application entry point.

Mounts all route modules and configures middleware.
All business logic lives in app/use_cases/, all route definitions in interfaces/api/.
"""
...
# Configure generators with settings (keeps generators decoupled from infrastructure)
from generators.utils import configure as configure_generators
