...
def multilingual_dataset(
    ...
    return start_generation(
        background_tasks, "multilingual", output_name, current_user.id, dataset_repo,
        generator_fn=generate_multilingual_dataset,
        generator_kwargs=dict(topic=topic, source_language=source_language,
                              target_language=destination_language, model=model,
